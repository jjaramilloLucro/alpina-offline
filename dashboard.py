...
if no_rec <= 0:
    ...
    bt1 = col1.button("Ver Imagenes no Reconocidas" )
    bt2 = col2.button("Ver Errores de Máquina")
    bt3 = col3.button("Ver Errores de Servidor")
    bt4 = col4.button("Ver Imagenes sin Reconocimiento")
